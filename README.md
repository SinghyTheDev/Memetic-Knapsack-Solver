...
Evolutionary algorithms are a field of AI inspired by the evolutionary process of life. Genetic algorithms are a branch of evolutionary algorithms which mimic the genetic principle if survival of the fittest.
