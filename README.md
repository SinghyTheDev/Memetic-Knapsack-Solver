...
## Problem Description
The Knapsack Problem is a combinatorial optimization problem in which you need to select a combination of items from a given list, each with a weight and profit, to maximize the total profit while staying within the weight limit.
